...
class CustomPDF(FPDF):
    def __init__(self, chat_id, *args, **kwargs):
        ...
        self.add_font("DejaVuSans", "", "assets/DejaVuSans.ttf", uni=True)  # Load DejaVuSans font

    def header(self):
        self.set_font('DejaVuSans', '', 12)  # Use DejaVuSans font
    ...
    def footer(self):
        self.set_y(-30)
        self.set_font('DejaVuSans', '', 10)  # Use DejaVuSans font
...
def generate_pdf(message, cookies, balance_info):
    ...
    pdf.add_page()
    pdf.set_background_color(173, 216, 230)  # Light blue background
    pdf.set_font("DejaVuSans", size=12)  # Use DejaVuSans font
    pdf.set_text_color(0, 0, 0)
    pdf.ln(10)
    # Sanitize the first name to remove any non-ASCII characters
    first_name = sanitize_text(user_data[chat_id].get("first_name", "Unknown"))
    user_id = chat_id
    pdf_id = generate_pdf_id()
    # Add user details (First Name, User ID, and PDF ID)
