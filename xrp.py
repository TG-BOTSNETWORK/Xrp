...
class CustomPDF(FPDF):
    ...
    def header(self):
        ...
        header_text = f"FIRST NAME: {first_name}   User ID: {self.chat_id}   PDF ID: {pdf_id}"
...
def generate_pdf(message, cookies, balance_info):
    ...
    if chat_id not in user_data:
        print("User data not found for chat ID")
        return

    # Ensure user_data has first_name for the chat_id
    user_data[chat_id].setdefault("first_name", message.from_user.first_name)
