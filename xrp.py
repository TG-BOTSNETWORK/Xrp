...
class CustomPDF(FPDF):
    def header(self):
        self.set_font('Days', '', 12)
        self.cell(0, 10, f"FIRST NAME: {self.first_name} | User ID: {self.user_id} | PDF ID: {self.pdf_id}", ln=True, align='C')
        self.ln(10)

    def footer(self):
        self.set_y(-30)
        self.set_font('Days', 'I', 10)
        self.cell(0, 10, 'Report generated by XRP Miner Bot - Created by Nobitha', ln=True, align='C')

    def add_watermark(self, text):
        self.set_font('Days', 'B', 50)
...
def generate_pdf(cookies, balance_info, first_name, user_id):
    pdf = CustomPDF()
    pdf.add_page()

    pdf.pdf_id = str(random.randint(1000, 9999))
...
async def balance(client, message: Message):
    ...
    generate_pdf(cookies, balance_info, message.from_user.first_name, message.from_user.id)
